...
#pragma warning restore 1066
                ...
                public static Task<long> Invalidate(string key)
                {
                    ...
                    return Cache.PubSub.Publish(SharedCache.CACHE_INVALIDATION_CHANNEL, key);
                }
                ...
                public static Task<long> Invalidate(string[] keys)
                {
                    ...
                    return Cache.PubSub.Publish(SharedCache.CACHE_MULTIPLE_INVALIDATION_CHANNEL, multipleKeys);
                }
            }
        }
    }
